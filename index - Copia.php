        ...
        <form id="mainForm" enctype="multipart/form-data">
            ...
            <div class="card">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        <label>CODEMP (Empresa)</label>
                        <input type="number" name="codemp" placeholder="1" min="1" required>
                    </div>
                    <div class="form-group">
                        <label>Login</label>
                ...
                <div class="form-group">
                    ...
                    <div class="file-upload">
                        <label class="file-upload-btn" id="fileLabel">
                            ...
                            <input type="file" name="arquivo_txt" id="fileInput" accept=".txt,.csv" required>
                        </label>
                    </div>
                </div>
            </div>
